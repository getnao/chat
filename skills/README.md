...
| [migrate-metabase-dashboard](./migrate-metabase-dashboard) | Migrate a Metabase dashboard to a verified nao story using read-only Metabase extraction and nao MCP story primitives. | Moving an existing Metabase dashboard into nao. |
